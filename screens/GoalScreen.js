...
class GoalScreen extends React.Component {
  ...
  addGoal = async () => {
    let goals = [...this.props.goals, this.state.newGoal];
  ...
  goalDone = async id => {
    ...
    // upload to firestore
    await firestore()
      .collection(`Users/${deviceId}/logs`)
      .doc(this.props.logsDate)
      .set({
        goals,
      });
      ...
      <View style={styles.container}>
        <View style={styles.box}>
          <Text style={styles.subHeading}>
            {this.props.timeframe == 'day'
              ? 'Daily'
              : this.props.timeframe == 'week'
              ? 'Weekly'
              : 'Monthly'}{' '}
            Goals
          </Text>
          <View style={styles.horizontalView}>
            <TextInput
              ...
              placeholder="What do you aim to achieve?"></TextInput>
...
const mapStateToProps = state => ({
  ...
  timeframe: state.logs.timeframe,
